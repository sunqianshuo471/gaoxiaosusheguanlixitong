                            ...
                            <div class="table-responsive mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        工程师姓名
                                        <div class="layui-input-inline">
                                            <input type="text" id="gongchengshiNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="工程师姓名" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <script>
            ...
            if( yonghuNameSearchInput != null){
                if (yonghuNameSearchInput.val() != null && yonghuNameSearchInput.val() != '') {
                    searchForm.yonghuName = $('#yonghuNameSearch').val();
                            ...
                            //工程师姓名
            var gongchengshiNameSearchInput = $('#gongchengshiNameSearch');
            if( gongchengshiNameSearchInput != null){
                if (gongchengshiNameSearchInput.val() != null && gongchengshiNameSearchInput.val() != '') {
                    searchForm.gongchengshiName = $('#gongchengshiNameSearch').val();
                }
            }
                                                                                                        <!-- 本表的查询条件 -->
        ...
        function getDataList() {
            ...
            //级联表的
                ...
                gongchengshiName: searchForm.gongchengshiName,
        ...
        function setDataRow(item, number) {
            ...
            row.appendChild(yonghuPhotoCell);
                    ...
                    //工程师姓名
            var gongchengshiNameCell = document.createElement('td');
            gongchengshiNameCell.innerHTML = item.gongchengshiName;
            row.appendChild(gongchengshiNameCell);


                    //工程师手机号
            var gongchengshiPhoneCell = document.createElement('td');
            gongchengshiPhoneCell.innerHTML = item.gongchengshiPhone;
            row.appendChild(gongchengshiPhoneCell);


                //工程师头像
            var gongchengshiPhotoCell = document.createElement('td');
            var gongchengshiPhotoImg = document.createElement('img');
            var gongchengshiPhotoImgValue = item.gongchengshiPhoto;
            if(gongchengshiPhotoImgValue !=null && gongchengshiPhotoImgValue !='' && gongchengshiPhotoImgValue !='null'){
                    gongchengshiPhotoImg.setAttribute('src', gongchengshiPhotoImgValue);
                    gongchengshiPhotoImg.setAttribute('height', 100);
                    gongchengshiPhotoImg.setAttribute('width', 100);
                    gongchengshiPhotoCell.appendChild(gongchengshiPhotoImg);
            }else{
                    gongchengshiPhotoCell.innerHTML = "暂无图片";
            }
            row.appendChild(gongchengshiPhotoCell);
            ...
            if(window.sessionStorage.getItem('role') == '工程师' && item.baoxiuZhuangtaiTypes ==1 && item.gongchengshiId == null){
            ...
            if(window.sessionStorage.getItem('role') == '工程师' && item.baoxiuZhuangtaiTypes ==2 && item.gongchengshiId == window.sessionStorage.getItem('userId') ){
                var weixiuwanchengBtn = document.createElement('button');
                var weixiuwanchengAttr = 'weixiuwancheng(' + item.id + ')';
                weixiuwanchengBtn.setAttribute("type", "button");
                weixiuwanchengBtn.setAttribute("class", "btn btn-warning btn-sm");
                weixiuwanchengBtn.setAttribute("onclick", weixiuwanchengAttr);
                weixiuwanchengBtn.innerHTML = "维修完成";
                btnGroup.appendChild(weixiuwanchengBtn);
            }
        ...
        //接单
        function jiedan(id) {
            var mymessage = confirm("确定要接此维修单么？");
            if (mymessage == true) {
                httpJson("baoxiu/update", "POST", {
                    id:id,
                    baoxiuZhuangtaiTypes:2,
                    gongchengshiId:window.sessionStorage.getItem('userId'),
                }, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('接单成功');
        ...
        //维修完成
        function weixiuwancheng(id) {
            var mymessage = confirm("确定维修完成了么？");
            if (mymessage == true) {
                httpJson("baoxiu/update", "POST", {
                    id:id,
